...
public class QueryCheck {
  ...
  public QueryCheck(int q_index) {
    ...
    Q1result.addElement (new S1("Jarek Gryz", "05/10/95"));
    Q1result.addElement (new S1("David Dewitt", "05/11/95"));
    Q1result.addElement (new S1("Parke Godfrey", "05/12/95"));
		
	Q2result.addElement (new S2("David Dewitt", "Enterprise"));
	Q2result.addElement (new S2("Parke Godfrey", "Voyager"));
	Q2result.addElement (new S2("Jarek Gryz", "Buckey"));
	Q2result.addElement (new S2("Jarek Gryz", "Wisconsin"));
    ...
    Q3result.addElement (new S3("Jarek Gryz"));
    Q3result.addElement (new S3("Jarek Gryz"));
    Q3result.addElement (new S3("Jarek Gryz"));    
    ...
    Q4result.addElement (new S3("Jarek Gryz"));
    ...
    Q5result.addElement (new S5("Jarek Gryz", 9, (float)40.3));
    Q5result.addElement (new S5("Jarek Gryz", 9, (float)40.3));
    Q5result.addElement (new S5("Jarek Gryz", 9, (float)40.3));
    ...
    Q6result.addElement (new S3("Jarek Gryz"));
